...
class queryAgeReq PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_test_5ftinypb_5fserver_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void queryAgeRes::set_res_info(const char* value) {
  ...
  res_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:queryAgeRes.res_info)
}
inline void queryAgeRes::set_res_info(const char* value,
    size_t size) {
  
  res_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
